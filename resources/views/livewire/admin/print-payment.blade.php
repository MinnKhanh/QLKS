...
<div id="details" class="row mb-5 justify-content-center">
    <div class="col col-6 text-center ">
        <ul>
            <li class="col-xs-12">
                <p class="d-inline-block">Tên Khách Hàng: </p><span id="partner-name">{{ $payment['customer']['name'] }}</span>
            </li>

            <li class="col-xs-12">
                <p class="d-inline-block">SĐT: </p><span id="partner-address">{{ $payment['customer']['phone'] }}</span>
            </li>

            <li class="col-xs-12">
                <p class="d-inline-block">CMTND: </p><span id="partner-tin-no">{{ $payment['customer']['cmtnd'] }}</span>
            </li>
...
<div id="note" class="mb-5 ml-4">
    <h3>Ghi chú:</h3>
    <div contenteditable="true">{{ $payment['note']}}
    </div>
</div>
